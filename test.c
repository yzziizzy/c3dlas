...
void checkTriPlaneClip() {
	...
	Vector tri1[] = { // intersecting
		{ 0,0, 5},
		{-3,0,-3}, // l,h
		{ 3,0,-3},
	};
	
	Vector tri11[] = { // intersecting
		{-3,0, 3}, // l,h
		{ 3,0, 3},
		{ 0,0,-5},
	};
	
	Vector tri2[] = { // entirely above
		{3,4,2},
		{3,5,3},
		{3,6,7},
	};
	...
	Vector n[] = {{999,999,999},{999,999,999},{999,999,999},{999,999,999},{999,999,999},};
	
	vpTriFaceNormal(o1, &n[0]);
	vpTriFaceNormal(o1+3, &n[1]);
	vpTriFaceNormal(o2, &n[2]);
	vpTriFaceNormal(o2+3, &n[3]);
	vpTriFaceNormal(tri3, &n[4]);
	...
	printf("  nb1: % .2f,% .2f,% .2f\n", n[2].x, n[2].y, n[2].z);
	printf("  nb2: % .2f,% .2f,% .2f\n", n[3].x, n[3].y, n[3].z);
	printf("  %f, %f, %f\n", vDot(n, n+2), vDot(n, n+1), vDot(n+2, n+3));
